...
TRIGGER_DELAY_STEPS = [
    (0.0,     250.0,   45.0, 70.0),   # вплотную: медленно, по-человечески
    (250.0,   500.0,   25.0,  50.0),   # ближняя
    (500.0,   800.0,   15.0,  30.0),   # средняя
    (800.0,  1200.0,   8.0,  20.0),   # дальняя
    (1200.0, 2000.0,   4.0,  10.0),   # очень дальняя
    (2000.0, 99999.0,   2.0,  5.0),   # экстремально далеко
]
